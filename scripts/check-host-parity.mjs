...
function checkHost(host, label) {
  ...
  if (host.runtimeProvider?.nativeBinding !== 'dist/native/asha-demo-runtime-provider.node') {
    errors.push(`${label} must name the consumer-composed native RuntimeSession provider`);
  }
